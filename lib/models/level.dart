...
class LevelConfig {
  ...
  static List<LevelConfig> get defaultLevels => [
    LevelConfig(
      levelNumber: 1,
      name: "Vortex Spiral (Uzun Burilish)",
      controlPoints: const [
        Waypoint(40, 80),
        Waypoint(360, 80),
        Waypoint(360, 660),
    ...
    LevelConfig(
      levelNumber: 2,
      name: "Hex Spiral (Burchakli Spiral)",
      controlPoints: const [
        Waypoint(200, 80),
        Waypoint(360, 180),
        Waypoint(360, 540),
    ...
    LevelConfig(
      levelNumber: 3,
      name: "Loop Spiral (Tugunli Spiral)",
      controlPoints: const [
        Waypoint(50, 90),
        Waypoint(350, 90),
        Waypoint(350, 640),
    ...
    LevelConfig(
      levelNumber: 4,
      name: "Large Spiral (Katta Spiral)",
      controlPoints: const [
        Waypoint(200, 90),
        Waypoint(360, 150),
        Waypoint(360, 580),
    ...
    LevelConfig(
      levelNumber: 5,
      name: "Simple Spiral (Oddiy Spiral)",
      controlPoints: const [
        Waypoint(40, 100),
        Waypoint(350, 100),
        Waypoint(350, 580),

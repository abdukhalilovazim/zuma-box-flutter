                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            fontWeight: FontWeight.w900,
                            letterSpacing: 6.0,
                            color: GameConstants.neonText.withValues(
                              alpha: 0.9,
                            ),
                          ),
                        ),
                    ...
                    GlassCard(
                      ...
                      child: Row(
                        ...
                        children: ["UZ", "RU", "EN"].map((lang) {
                          final isSelected =
                              controller.currentLanguage == lang.toLowerCase();
                        ...
                        child: ScrollConfiguration(
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final isUnlocked = unlockedLevels.contains(
                                levelNum,
                              );
                              final levelColor = GameConstants.getLevelColor(
                                index % 5,
                                  ...
                                  children: [
                                    GlassCard(
                                      ...
                                      borderColor: isCompleted
                                          ? GameConstants.neonGreen.withValues(
                                              alpha: 0.85,
                                            )
                                          : (isUnlocked
                                      ...
                                      color: isUnlocked
                                          ? GameConstants.cardBg.withValues(
                                              alpha: 0.4,
                                            )
                                          : Colors.black38,
                                      child: Center(
